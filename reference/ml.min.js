    ...
    var f = new e
      , a = (t.prototype = {
        ...
        play: function(t, i) {
            ...
            var l, d, c, _, p = Math.max(0, 0 < s._seek ? s._seek : o._sprite[t][0] / 1e3), u = Math.max(0, (o._sprite[t][0] + o._sprite[t][1]) / 1e3 - p), h = 1e3 * u / Math.abs(s._rate), v = o._sprite[t][0] / 1e3, g = (o._sprite[t][0] + o._sprite[t][1]) / 1e3, j = !(!s._loop && !o._sprite[t][2]), m = (s._sprite = t,
            s._ended = !1,
            function() {
                s._paused = !1,
                s._seek = p,
            ...
            void 0 !== t)
                if ("loaded" !== i._state || i._playLock)
                    ...
                    if (r) {
                        ...
                        var s, l = i.playing(t), d = (l && i.pause(t, !0),
                        r._seek = e,
                        r._ended = !1,
                        i._clearTimer(t),
...
},
{
  ...
  , game_load = (jv.base64_encode = function(e) {
    ...
    var t, i, o, n, a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", r = 0, s = 0, l = "", d = [];
    if (!e)
        return e;
...
jv.base64_decode = function(e) {
    ...
    var t, i, o, n, a, r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", s = 0, l = 0, d = "", c = [];
    if (!e)
        return e;
...
var tile_path = path, res = res.concat([path + "data/misc/splash_screen.jpg" + vt, path + "data/misc/mapfont.fnt" + vt, tile_path + "data/misc/tile16.png" + vt, tile_path + "data/misc/item16.png" + vt, path + "data/misc/compass.png" + vt, path + "data/misc/button.png" + vt, path + "data/misc/star.png" + vt, path + "data/misc/edges.png" + vt, path + "data/misc/chat_say.png" + vt, path + "data/misc/chat_tell.png" + vt, path + "data/misc/chat_global.png" + vt, path + "data/misc/chat_tribe.png" + vt, path + "data/misc/chat_party.png" + vt, path + "data/misc/sound_icon.png" + vt, path + "data/misc/music_icon.png" + vt, path + "data/misc/color.png" + vt, path + "data/misc/buffs.png" + vt]), sound = (jv.load(res),
...
function(e, t) {
    ...
    var r, s, l, d = new PIXI.Container, e = jv.sprite(path + "data/body/b" + e + ".png" + vt), c = jv.sprite(path + "data/body/e1.png" + vt), _ = jv.sprite(path + "data/clothes/c" + t + "_a.png" + vt), p = (-1 != clothes_fixed.indexOf(t) && (r = jv.sprite(path + "data/clothes/c" + t + "_b.png" + vt)),
...
}, tile2x = function(e) {}, append = function(e) {
...
jv.buildup_object = function(e) {
    ...
    e.other)
        ...
        e.other[t] = null);
    e.other = [];
    var i, o, n, a, r, s, l, d, c = -1 !== e.build.indexOf("a"), _ = e.build.split(","), p = e.x, u = e.y, h = 0, v = 0, g = 0;
    for (t in _)
        o = i = 0,
